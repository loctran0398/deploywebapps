...
#mm 09042018: Change new API link (also change format)
#ACCURACY_LINK = "/LiveForecast/Drivers/Accuracy/{client_id}/?h_id_parent={h_id}"
#mm 09212018: Change new accuracy API link (not change format)
ACCURACY_LINK = "/PMIAuto/Drivers/Accuracy/{client_id}/?h_id_parent={h_id}"
